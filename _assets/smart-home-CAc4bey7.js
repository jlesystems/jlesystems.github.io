import{B as e}from"./index-ClwKTyeh.js";import{u as s}from"./index-Bce0Eq0j.js";const r=["/articles/smart-home/image-en.jpg"];function i(t){const n={a:"a",blockquote:"blockquote",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Smart Home – A Tech­nical Guide"}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/articles/smart-home/image-en.jpg",alt:"[AR:16/9][FW:60%][MW:36rem]Symbol image (AI): critical functionality vs. intelligence and logic"})}),`
...
`,e.jsx(n.li,{children:"If a window is open in winter for more than 5 minutes → push noti­fication and reduce heating output."}),`
...
`,e.jsx(n.h2,{children:"3) Con­clusion"}),`
...
`,e.jsx(n.li,{children:"What is “nice to have”? (scenes, presence logic, voice control, energy opti­mization)"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Your preferred time without waiting:"})}),`
...
`,e.jsx(n.p,{children:e.jsxs(n.a,{href:"/contact",children:["[BUTTON]",e.jsx(n.strong,{children:"Contact"})]})})]})}function l(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{l as default,r as images};
