import{B as e}from"./index-CPPtXIXj.js";import{u as s}from"./index-DH1NNa4K.js";const l=["/articles/smart-home/image-de.jpg"];function r(i){const n={a:"a",blockquote:"blockquote",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Smart Home – Ein tech­nisch­er Leit­faden"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Layer-2 (Gehirn):"})," Hier findet die komplexe Verarbeitung statt. Was mache ich mit meinem Energie­überschuss – laufen gehen? Im Haus entscheidet das Gehirn, ob der PV-Überschuss z. B. für die Waschmaschine verwendet wird."]}),`
`]}),`
...
`,e.jsx(n.p,{children:"Allerdings sind die Unterschiede in der Praxis meist weniger „schwarz/weiß“, als es auf den ersten Blick erkennbar ist. Beim Bus kann eine Unterbrechung des Buskabels je nach Topologie/Segmen­tierung ebenfalls größere Bereiche betreffen. Als zentrale Steuerung werden außerdem sogenannte speicher­programmierbare Steuerungen (SPS oder englisch PLC) verwendet. Diese sind extrem robust und seit Jahrzehnten fixer Bestandteil in der Industrie, wo Ausfallsicherheit eine extrem wichtige Rolle spielt. Auch der Mehraufwand bei der Verkabelung ist in vielen Projekten geringer, als man vermuten könnte. Da Steuerstromkreise häufig im Klein­spannungsbereich (z. B. 24 V, je nach Konzept) arbeiten, können problemlos mehrere Kreise in einem Kabel realisiert werden, wodurch man die Anzahl der zu verlegenden Kabel reduziert. Ein großer Vorteil der Steuerung liegt häufig beim Preis. Da nicht jeder Teilnehmer „smart“ sein muss, können klassische Elemente (Standard-Taster) verwendet werden. Das spart Geld. Auch Steuerungen gibt es sehr preiswert."}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Beispiel-Automati­sierungen:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Wenn PV-Überschuss und Warmwasser unter X °C → Warmwasser­auf­bereitung starten."}),`
`,e.jsx(n.li,{children:"Wenn Fenster im Winter länger als 5 Minuten offen → Push-Benach­richtigung und Heiz­leistung reduzieren."}),`
`,e.jsx(n.li,{children:"Wenn niemand zu Hause (Präsenz) → ausgewählte Verbraucher de­aktivieren und Alarm-Logik scharf schalten."}),`
`]}),`
`]}),`
...
`,e.jsx(n.h3,{children:"1.4) Häufige Planungs­fehler"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Kritische Funktionen nur über Layer-2 bedienbar machen"}),`
`,e.jsx(n.li,{children:"Ungeeignete Layer-1-Hardware oder Standards (WLAN) als Basis für Licht/Be­schattung verwenden"}),`
`,e.jsx(n.li,{children:"Keine manuelle Fallback-Bedienung für kritische Funktionen vorsehen (keine manuellen Steuer­stromkreise)"}),`
...
`,e.jsx(n.p,{children:"Eine bekannte Lösung ist Loxone. Es vereint Layer-1 und Layer-2 zu einem System: alles aus einer Hand, gut aufeinander abgestimmt. Das hat allerdings oft einen höheren Einstiegspreis, und man entscheidet sich dabei in der Regel für ein stark „ökosystem­gebundenes“ Setup: Man setzt primär auf Hardware/Kompo­nenten aus dem Loxone-Umfeld und nutzt Integrationen zu Drittsystemen je nach Bedarf."}),`
...
`,e.jsx(n.p,{children:"Dies ist mein favorisierter Ansatz. Wir nutzen eine Arduino Opta (eine offene Industrie-SPS) als robuste Basis für Licht und Jalousien (Layer-1). PV- und Heizungssysteme mit eigenem Layer-1 werden direkt in HA (Layer-2) integriert. Wir sind hier weitgehend hersteller­unabhängig und können klassische Komponenten (Taster, Lampen, …) verwenden."}),`
`,e.jsx(n.p,{children:"Für komplexe Beleuchtungs­szenarien lässt sich das System einfach mit DALI-2 (Licht-Standard) erweitern. DALI-2 ist ein Bus zur Steuerung von LED-Lampen und wird ab einer gewissen Komplexität/Anzahl von Leuchtgruppen oft sinnvoll. DALI-2 kann – je nach Projekt – auch in Kombination mit KNX oder anderen Systemen eingesetzt werden (die Sinnhaftigkeit sollte hier allerdings gesondert evaluiert werden)."}),`
...
`]}),`
`,e.jsx(n.p,{children:"Licht, Beschattung und grundlegende Sicherheits­funktionen müssen immer bedienbar bleiben – unabhängig von App, Cloud oder Internet. Die direkte Integration von kritischen Funktionen in Layer-2-Systeme ist auch ohne App-, Cloud- oder Internet­abhängigkeit nicht zu empfehlen, da spezielle Hardware für Layer-1-Systeme erforderlich ist. Die „Intelligenz“ (Automatisierungen, Energiemanagement, Visualisierung) darf Komfort bringen, aber kein Single Point of Failure für den Alltag werden."}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Was muss im Haus immer funktio­nieren? (Licht, Be­schattung, Heizung-Grundmodus, Warnungen)"}),`
`,e.jsx(n.li,{children:"Was ist „nice to have“? (Szenen, Präsenz­logik, Sprach­steuerung, Energie-Opti­mierung)"}),`
`,e.jsx(n.li,{children:"Wie viel Flexi­bilität wollen Sie in 5–10 Jahren noch haben? (Her­steller­bindung vs. offene Standards)"}),`
`]}),`
`]}),`
`,e.jsx(n.h3,{children:"3.1) Wenn Sie maximale Flexibilität wollen"}),`
`,e.jsx(n.p,{children:"Wenn Sie aus einem Konzept eine umsetzbare Lösung machen wollen, lohnt sich ein früher Blick auf Umfang (Scope) und Kosten-Treiber. Gerade bei Smart Homes entstehen Budget-Sprünge selten durch „smart“ an sich, sondern durch Anzahl der Kreise, Sonderfunktionen, Integrationen und den Installations­aufwand."}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Elektro­installation"})," (Ihr lokaler Elektriker)"]}),`
...
`,e.jsx(n.p,{children:e.jsxs(n.a,{href:"/contact",children:["[BUTTON]",e.jsx(n.strong,{children:"Kontakt"})]})})]})}function h(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{h as default,l as images};
