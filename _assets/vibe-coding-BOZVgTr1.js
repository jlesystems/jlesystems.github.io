import{B as e}from"./index-CPPtXIXj.js";import{u as t}from"./index-DH1NNa4K.js";const o=["/articles/vibe-coding/image.jpg"];function r(i){const n={a:"a",blockquote:"blockquote",h1:"h1",h2:"h2",h3:"h3",hr:"hr",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Vibe Coding – Die neue Art der Soft­ware­ent­wick­lung"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Fokus auf das Problem:"})," Anstatt sich mit der exakten Dokumentation einer bestimmten Programm­bibliothek aufzuhalten, kann der Entwickler seine kognitive Energie auf die Lösung des eigentlichen Geschäftsproblems richten."]}),`
`]}),`
...
`,e.jsx(n.p,{children:"Sie benötigen ein maßgeschneidertes Web-Tool, einen internen Generator oder eine hochperformante Web-Applikation? Ich verbinde modernste Entwicklungs­methoden mit solider, sicherer Systemarchitektur. Ich berate Sie gerne in einem kostenlosen und unverbindlichen Erstgespräch."}),`
