import{j as e}from"./index-CP70I_oO.js";import{u as s}from"./index-gcakm5fr.js";import"./preload-DSe_cG8J.js";const h=["/articles/smart-home/image-de.png"];function r(i){const n={a:"a",blockquote:"blockquote",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Smart Home – Ein technischer Leitfaden"}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/articles/smart-home/image-de.png",alt:"[AR:16/9][FW:60%][MW:36rem]Symbolbild (KI): kritische Funktionalität vs. Intelligenz und Logik"})}),`
