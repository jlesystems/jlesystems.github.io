import{j as e}from"./index-DzHO8a7t.js";import{u as t}from"./index-CPuqIoqg.js";const d=["/articles/vibe-coding/image.jpg"];function r(i){const n={a:"a",blockquote:"blockquote",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Vibe Coding – Die neue Art der Software­entwicklung"}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/articles/vibe-coding/image.jpg",alt:"[AR:1/1][MW:28rem]Symbolbild (KI): KI ein mächtiges Tool"})}),`
