import{j as e}from"./index-B156U3F0.js";import{u as t}from"./index-BrjSdCQY.js";const d=["/articles/vibe-coding/image.jpg"];function r(i){const n={a:"a",blockquote:"blockquote",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Vibe Coding – Die neue Art der Software­entwicklung"}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/articles/vibe-coding/image.jpg",alt:"[AR:1/1][MW:24rem][AB]Symbolbild (KI): KI ein mächtiges Tool"})}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"https://toolbox.jle.systems/gameplan/de",children:e.jsx(n.strong,{children:"Gameplan"})})," — kostenloser Turnierplan-Generator"]}),`
`]}),`
...
`]})]})}function l(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{l as default,d as images};
